...
<script type="text/javascript">
	$(document).ready(function() {
		$.getJSON("/eduSystem/loadInfo.do", function(data) {
            $('input[name="id"]').val(data.studentid);
            $('input[name="name"]').val(data.name);
            $('input[name="college"]').val(data.college);
            $('input[name="class"]').val(data.classname);
            $('input[name="inrolltime"]').val(data.inrolltime);
	...
	<div id="infodata">
		...
		<div id="basicinfo"
			...
			<table>
				...
				<tr>
					<td>班级：</td>
					<td><input name="class" type="text" value=""
						disabled="disabled"></td>
				</tr>
				<tr>
					<td>电话：</td>
				...
				<tr>
					<td>入学时间：</td>
					<td><input name="inrolltime" type="text" value="" disabled="disabled"></td>
				</tr>
			</table>
		</div>
	</div>
